    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, true, "مدينة نصر", "Nasr City" },
                    { 2, 1, true, "المعادي", "Maadi" },
                    { 3, 1, true, "مصر الجديدة", "Heliopolis" },
                    { 4, 2, true, "الدقي", "Dokki" },
                    { 5, 2, true, "السادس من أكتوبر", "6th of October" },
                    { 6, 2, true, "الهرم", "Haram" },
                    { 7, 3, true, "سموحة", "Smouha" },
                    { 8, 3, true, "ميامي", "Miami" }
                });
